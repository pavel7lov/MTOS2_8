...
public class MTOS2_8 extends PApplet {
...
public void setup(){
  ...
  taskbar.setFill(color(0xff2E2F55));
  mainLoc();
  createGUI();
  customGUI();
...
///
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "MTOS2_8" };
    if (passedArgs != null) {
